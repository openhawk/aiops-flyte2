...
assert_file_contains "$PUSH_SCRIPT" 'REGISTRY_NAMESPACE="${REGISTRY_NAMESPACE:-registry-system}"'
...
assert_file_contains "$PUSH_SCRIPT" 'for attempt in {1..30}'
assert_file_contains "$PUSH_SCRIPT" 'verify_public_image "$public_ref"'
