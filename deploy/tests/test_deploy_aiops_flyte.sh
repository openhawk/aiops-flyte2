...
assert_contains "CONTROL_PLANE_NODE='aione-flyte2'"
...
assert_contains 'kubernetes.io/hostname: ${CONTROL_PLANE_NODE}'
...
assert_contains '--set "flyte-binary.deployment.extraPodSpec.nodeSelector.kubernetes\\.io/hostname=$CONTROL_PLANE_NODE"'
...
assert_contains '--set "flyte-binary.console.nodeSelector.kubernetes\\.io/hostname=$CONTROL_PLANE_NODE"'
assert_contains '--set "rustfs.nodeSelector.kubernetes\\.io/hostname=$CONTROL_PLANE_NODE"'
